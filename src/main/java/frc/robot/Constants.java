...
public final class Constants {
  ...
  public static final class ShooterConstants {
    ...
    // Targets 
    public static final double SHOOTER_TOP_RPS = 40.0;
    public static final double SHOOTER_BOTTOM_RPS = 40.0;
    ...
    public static final double HOOD_QUADRATIC_A = 0.0;
    public static final double HOOD_QUADRATIC_B = 0.0;
    public static final double HOOD_QUADRATIC_C = 0.0;
  }
...
public static final class IntakePivotConstants {
  ...
  // Throughbore Encoder
  public static final int PIVOT_CANCODER_ID = 100;

  // Gear ratio: motorRot / pivotRot (CHANGE to your real ratio)
  public static final double PIVOT_GEAR_RATIO = 1.0;

  // Targets in PIVOT MECHANISM ROTATIONS (not degrees)
  // Example: 0.0 = stowed, 0.10 = deployed
  public static final double STOW_ROT = 0.0;
  public static final double DEPLOY_ROT = 0.10;

  // Safety clamp (mechanism rotations)
  public static final double MIN_ROT = -0.02;
  public static final double MAX_ROT = 0.20;
